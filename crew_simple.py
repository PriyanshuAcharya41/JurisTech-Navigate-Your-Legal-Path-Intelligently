...
from tasks.legal_drafter_task_simple import legal_drafter_task_simple # <-- Use the simple task

legal_assistant_crew_simple = Crew(
    agents=[case_intake_agent, ipc_section_agent, legal_precedent_agent, legal_drafter_agent],
    tasks=[case_intake_task, ipc_section_task, legal_precedent_task, legal_drafter_task_simple], # <-- Use the simple task
    verbose=True
)